sher_kar_adolescent_eventminion = Creature:new {
	customName = "Sher Adolescent",
...
CreatureTemplates:addCreatureTemplate(sher_kar_adolescent_eventminion, "sher_kar_adolescent_eventminion")
